...
export const transMailBookingNew = {
    subject: "Email notification of booking progress at AppointX",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at AppointX </h3>
        ...
        <h4>AppointX will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
    },
};
...
export const transMailRemedy= {
    ...
    template: (data) => {
        return `<h3>Thank you for your trust in booking a medical examination in AppointX</h3>
        ...
        <br>
        <div>For example: Full name: Gaurav, with the registered phone number: 0123456789 and born: 2000, the extracted password is: <b> abcdefhg-012-10 </b> </div>
        <br>
